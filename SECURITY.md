...
Replace this section with the supported versions for `atomcommit`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `atomcommit` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in atomcommit.
